...
<div id="art-main">
    <div class="art-sheet clearfix" style="position:relative;">
	
<header class="art-header clearfix">

<div class="art-shapes">
	<h1 class="art-headline" data-left="2.77%">
		<a href="#"></a> <!-- titulo de la pagina -->
	</h1>
...
<div class="art-content-layout layout-item-4">
    ...
    <div class="art-layout-cell layout-item-3" style="width: 25%" onmouseover='this.style.background="#FFB635"' onmouseout='this.style.background="white"'>
        <p style="text-align: center;"><img width="143" height="143" alt="" class="art-lightbox" src="catalogo/juegos-exclusivos/imagenes/ROAD-BLOCK.png"></p>
        <p style="text-align: center;"><span style="color: rgb(12, 157, 14); font-weight: bold;">ROAD BLOCK <br>  ____________</span></p>
        <p style="text-align: center;"><span style="font-weight: bold; color: rgb(250, 97, 20);">&nbsp;Disponible</span></p>
        <p style="text-align: center;">&nbsp;<a href="catalogo/juegos-exclusivos/ROAD-BLOCK.php#foco" class="art-button"><span style="background-color: rgb(12, 157, 14);">VER</span>&nbsp;<span style="background-color: rgb(12, 157, 14);">DETALLE</span><span style="background-color: rgb(12, 157, 14);">S</span></a>&nbsp;</p>
	...
	<div class="art-layout-cell layout-item-5" style="width: 25%" onmouseover='this.style.background="#FFB635"' onmouseout='this.style.background="white"'>
        <p style="text-align: center;"><img width="144" height="144" alt="" class="art-lightbox" src="catalogo/accesorios-para-bebes/imagenes/PIEZA-PARA-GATEO-Y-MASAJES.png"><br></p>
        <p style="text-align: center;"><span style="color: rgb(12, 157, 14); font-weight: bold;">PIEZA PARA GATEO Y MASAJES</span></p>
        <p style="text-align: center;"><span style="font-weight: bold; color: rgb(250, 97, 20);">&nbsp;Disponible</span></p>
        <p style="text-align: center;">&nbsp;<a href="catalogo/accesorios-para-bebes/PIEZA-PARA-GATEO-Y-MASAJES.php#foco" class="art-button"><span style="background-color: rgb(12, 157, 14);">VER</span>&nbsp;<span style="background-color: rgb(12, 157, 14);">DETALLE</span><span style="background-color: rgb(12, 157, 14);">S</span></a>&nbsp;</p>
        ...
        <p style="text-align: center;"><img width="144" height="144" alt="" class="art-lightbox" src="catalogo/juegos-exclusivos/imagenes/JUEGO-EXCLUSIVO-AIRPORT.png"><br></p>
        <p style="text-align: center;"><span style="color: rgb(12, 157, 14); font-weight: bold;">JUEGO EXCLUSIVO<br> AIRPORT;</span><span style="color: rgb(12, 157, 14); font-weight: bold;">&nbsp;</span></p>
        <p style="text-align: center;"><span style="font-weight: bold; color: rgb(250, 97, 20);">&nbsp;Disponible</span></p>
        <p style="text-align: center;">&nbsp;<a href="catalogo/juegos-exclusivos/JUEGO-EXCLUSIVO-AIRPORT.php#foco" class="art-button"><span style="background-color: rgb(12, 157, 14);">VER&nbsp;</span><span style="background-color: rgb(12, 157, 14);">DETALLE</span><span style="background-color: rgb(12, 157, 14);">S</span></a>&nbsp;</p>
        <p><span style="color: #0C9D0E;"></span></p>
    </div><div class="art-layout-cell layout-item-3" style="width: 25%" onmouseover='this.style.background="#FFB635"' onmouseout='this.style.background="white"'>
        <p style="text-align: center;"><img width="144" height="144" alt="" class="art-lightbox" src="catalogo/ninos-0-a-2-motricidad-fina/imagenes/ENCAJE-CASA-DESARMABLE.png"><br></p>
        <p style="text-align: center;"><span style="color: rgb(12, 157, 14); font-weight: bold;">ENCAJE CASA <br> DESARMABLE;</span></p>
        <p style="text-align: center;"><span style="font-weight: bold; color: rgb(250, 97, 20);">&nbsp;Disponible</span></p>
        <p style="text-align: center;">&nbsp;<a href="catalogo/ninos-0-a-2-motricidad-fina/ENCAJE-CASA-DESARMABLE.php#foco" class="art-button"><span style="background-color: rgb(12, 157, 14);">VER</span>&nbsp;<span style="background-color: rgb(12, 157, 14);">DETALLE</span><span style="background-color: rgb(12, 157, 14);">S</span></a>&nbsp;</p>
    </div>
    </div>
</div>
</div>
...
<div class="art-content-layout layout-item-4">
    <div class="art-content-layout-row">
    <div class="art-layout-cell layout-item-3" style="width: 25%" onmouseover='this.style.background="#FFB635"' onmouseout='this.style.background="white"'>
        <p style="text-align: center;"><img width="147" height="147" alt="" class="art-lightbox" src="catalogo/ninos-3-a-5-motricidad-fina/imagenes/MOSAICO-IMANTADO.png"><br></p>
        <p style="text-align: center;"><span style="font-weight: bold; color: rgb(12, 157, 14);">MOSAICO IMANTADO<br>  ____________</span></p>
        <p style="text-align: center;"><span style="color: rgb(250, 97, 20); font-weight: bold;">Disponible</span><br></p>
        <p style="text-align: center;">&nbsp;<a href="catalogo/ninos-3-a-5-motricidad-fina/MOSAICO-IMANTADO.php#foco" class="art-button"><span style="background-color: rgb(12, 157, 14);">VER</span>&nbsp;<span style="background-color: rgb(12, 157, 14); ">DETALLE</span><span style="background-color: rgb(12, 157, 14);">S</span></a>&nbsp;</p>
        <p style="text-align: center;"><br></p>
        ...
        <p style="text-align: center;"><img width="143" height="143" alt="" class="art-lightbox" src="catalogo/educativos-expresion-musical/imagenes/XILOFONO-DE-DOCEOCTAVAS.png"><br></p>
        <p style="text-align: center;"><span style="font-weight: bold; color: rgb(12, 157, 14);">XILOFONO DE DOCE OCTAVAS</span></p>
        <p style="text-align: center;"><span style="color: rgb(250, 97, 20); font-weight: bold;">Disponible</span><br></p>
        <p style="text-align: center;">&nbsp;<a href="catalogo/educativos-expresion-musical/XILOFONO-DE-DOCEOCTAVAS.php#foco" class="art-button"><span style="background-color: rgb(12, 157, 14);">VER</span>&nbsp;<span style="background-color: rgb(12, 157, 14);">DETALLE</span><span style="background-color: rgb(12, 157, 14);">S</span></a>&nbsp;</p>
        <p style="text-align: center;"><br></p>
    </div><div class="art-layout-cell layout-item-3" style="width: 25%" >
        <p><br></p>
    </div><div class="art-layout-cell layout-item-3" style="width: 25%" >
