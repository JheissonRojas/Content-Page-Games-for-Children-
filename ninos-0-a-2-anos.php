...
<p>                                  </p></div>
						...
						<article class="art-post art-article">
                                <div class="art-postmetadataheader">
                                        <h1 class="art-postheader">Niños de 0 a 2 años</h1>
                                    </div>
...
<div class="art-content-layout layout-item-4">
	...
	<!-- $$$$$$$$$$$$$$$$$   FRASE DE LA CATEGORIA    $$$$$$$$$$$$$$$$$$$$$$$ -->
	        ...
	        <p style="text-align: left;"><span style="color: rgb(17, 20, 23); font-size: 14px;">Frase &nbsp;de la categoruia</span></p>
...
<div class="art-content-layout layout-item-4">
    ...
    <div class="art-layout-cell layout-item-5" style="width: 100%" >
		...
		<a href="ninos-0-a-2-anos-motricidad-fina-2.php">2</a> &nbsp;&nbsp;&nbsp;
		<a href="ninos-0-a-2-anos-motricidad-fina-3.php">3</a> &nbsp;&nbsp;&nbsp;
		<a href="ninos-0-a-2-anos-motricidad-fina-2.php">Siguiente&gt;&gt;</a></span>
	<hr>	
    </div>
    </div>
</div>
...
<div class="art-content-layout layout-item-4">
    ...
    <div class="art-layout-cell layout-item-3" style="width: 25%" onmouseover='this.style.background="#FFB635"' onmouseout='this.style.background="white"'>
        ...
        <p style="text-align: center;">&nbsp;<a href="ninos-0-a-2-anos-motricidad-fina-1/balancin-oso.php" class="art-button"><span style="background-color: rgb(12, 157, 14);">VER</span>&nbsp;<span style="background-color: rgb(12, 157, 14);">DETALLE</span><span style="background-color: rgb(12, 157, 14);">S</span></a>&nbsp;</p>
